...
class EntriesNotifier
  ...
  Future<void> loadEntries() async {
    if (_bookId == null) { state = const AsyncValue.data([]); return; }
    try {
      final data = await _storage.getEntryData(_bookId!);
...
final entriesProvider =
    StateNotifierProvider.family<EntriesNotifier,
